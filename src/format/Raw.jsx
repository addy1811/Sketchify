...
import './Raw.css'; // Import your CSS file for custom styles
...
const Raw = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile) {
      if (selectedFile.type !== "image/raw") {
        alert("Only RAW files are supported. Please upload a valid RAW image.");
  ...
  return (
    <div className="relative min-h-screen bg-gray-200">
      ...
      <div className="content-box">
        <h1 className="text-2xl font-bold mb-6 text-white">Add RAW Image</h1>
        <div className="border-2 border-dashed border-gray-600 p-6 rounded-lg text-center mb-4">
          ...
          <h3 className="text-xl text-white">Upload your RAW image here</h3>
          <h4 className="text-sm opacity-50 mt-2 text-white">File supported: RAW</h4>
