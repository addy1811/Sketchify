...
import './Psd.css'; // Import your CSS file for custom styles
  ...
  return (
    <div className="relative min-h-screen bg-gray-200">
      ...
      <div className="content-box">
        <h1 className="text-2xl font-bold mb-6 text-white">Add PSD Image</h1>
        <div className="border-2 border-dashed border-gray-600 p-6 rounded-lg text-center mb-4">
          ...
          <h3 className="text-xl text-white">Upload your PSD image here</h3>
          <h4 className="text-sm opacity-50 mt-2 text-white">File supported: PSD</h4>
